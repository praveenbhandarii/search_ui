        ...
        >
          <Modal.Body>
            <div className="space-y-6">
              <p className="font-medium text-base leading-relaxed text-gray-500 dark:text-gray-400">
                OTP SENT to {email}
              </p>
          ...
          <Modal.Footer>
            <Button onClick={otpCheck}>Register</Button>
            ...
            <div className="hidden lg:flex flex-col justify-between bg-[url('/signinbg.svg')] bg-cover bg-no-repeat lg:p-8 xl:p-12 lg:max-w-sm xl:max-w-lg">
              ...
              <div className="space-y-5">
                ...
                <Link href="/signin" replace>
                  <button className="inline-block flex-none px-4 py-3 border-2 rounded-xl font-medium bg-white text-primarycolor">
                    Sign in
                  </button>
                </Link>
              </div>
