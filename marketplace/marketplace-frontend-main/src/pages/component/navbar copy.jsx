...
const Navbar = () => {
  ...
  useEffect(() => {
    let config = {
      ...
      headers: {
        Authorization: "Token e290531cd1ac00c999b8f687c46fe88cfc5c7ede"
      }
    };
  ...
  return (
    <header className="flex flex-wrap sm:justify-start sm:flex-nowrap z-50 w-full border-b-2 border-gray-200 text-sm py-3 sm:py-0 ">
      <nav
