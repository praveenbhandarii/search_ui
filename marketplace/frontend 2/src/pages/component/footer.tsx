...
const Footer = () => {
  return (
    <footer className="px-3 pt-4 lg:px-9 bg-white text-white z-50 relative">
      <div className="grid mt-20 mx-10 gap-10 row-gap-6 mb-8 sm:grid-cols-2 lg:grid-cols-4">
        <div className="sm:col-span-2">
          <Link href="#" className="inline-flex items-center">
            {/* <img src="/lylogofull.svg" alt="My SVG" width={200} height={200} /> */}
            <svg
              width="215"
              height="39"
              viewBox="0 0 215 39"
            ...
            >
              ...
              />
              <path
                d="M 40.2 30.8 V 5.4 H 43.2 V 28.2 H 56 V 30.8 H 40.2 Z"
                fill="#212121"
              />
              <path
          ...
          {/* <div className="mt-6 text-[#353535] text-lg not-italic font-light leading-[normal] tracking-[-0.66px]">
            <div className="flex gap-2 ">
              ...
              <div>
                ...
                >
                  <path
                    d="M7.17796 6.27478C7.11316 6.34933 7.07888 6.4456 7.08198 6.54433C7.08508 6.64306 7.12532 6.73699 7.19466 6.80733C7.26401 6.87767 7.35734 6.91925 7.45601 6.92374C7.55468 6.92824 7.65141 6.89533 7.72686 6.83158L13.2159 1.342V4.14953C13.2175 4.25302 13.2593 4.35182 13.3325 4.42501C13.4057 4.4982 13.5045 4.54003 13.6079 4.54164C13.7119 4.54164 13.8116 4.50033 13.8852 4.4268C13.9587 4.35326 14 4.25353 14 4.14953V0.393089C14 0.289095 13.9587 0.189359 13.8852 0.115824C13.8116 0.0422882 13.7119 0.000976562 13.6079 0.000976562H9.85189C9.74791 0.000976562 9.64818 0.0422882 9.57465 0.115824C9.50113 0.189359 9.45982 0.289095 9.45982 0.393089C9.45982 0.497084 9.50113 0.59682 9.57465 0.670355C9.64818 0.74389 9.74791 0.785202 9.85189 0.785202H12.6591L7.17796 6.27478Z"
                    fill="#353535"
                  />
                  <path
                    d="M11.6069 14H2.39163C1.75752 13.9994 1.14956 13.7472 0.701181 13.2987C0.252798 12.8503 0.000622796 12.2423 0 11.6081V2.39189C0.000622796 1.75771 0.252798 1.14969 0.701181 0.701256C1.14956 0.252825 1.75752 0.000622862 2.39163 0H7.11845C7.22243 0 7.32215 0.0413119 7.39568 0.114847C7.46921 0.188383 7.51052 0.288118 7.51052 0.392113C7.51052 0.496108 7.46921 0.595843 7.39568 0.669379C7.32215 0.742914 7.22243 0.784226 7.11845 0.784226H2.39163C1.96549 0.784848 1.55698 0.954426 1.25565 1.25579C0.954325 1.55715 0.784765 1.9657 0.784142 2.39189V11.6081C0.784765 12.0343 0.954325 12.4429 1.25565 12.7442C1.55698 13.0456 1.96549 13.2152 2.39163 13.2158H11.6069C12.033 13.2152 12.4415 13.0456 12.7429 12.7442C13.0442 12.4429 13.2137 12.0343 13.2144 11.6081V6.88158C13.2144 6.77759 13.2557 6.67785 13.3292 6.60432C13.4027 6.53078 13.5025 6.48947 13.6064 6.48947C13.7104 6.48947 13.8101 6.53078 13.8837 6.60432C13.9572 6.67785 13.9985 6.77759 13.9985 6.88158V11.6081C13.9979 12.2423 13.7457 12.8503 13.2973 13.2987C12.8489 13.7472 12.241 13.9994 11.6069 14Z"
                    fill="#353535"
                  />
                </svg>
              </div>
        ...
        <div className="flex flex-col gap-2 text-sm">
          <p className="text-base font-medium text-[#252525] tracking-wide">
            Company
          </p>
          <Link className="text-[#2C2C2C]" href="/about">
            About
          </Link>
          {/* <Link className="text-[#949494]" href="#">
            Blog
          </Link> */}
          <Link className="text-[#2C2C2C]" href="/contact">
            Contact us
          </Link>
        </div>
        <div className="flex flex-col gap-2 text-sm">
          ...
          <Link className="text-[#2C2C2C]" href="/privacy">
            Privacy policy
          </Link>
          <Link className="text-[#2C2C2C]" href="/terms" scroll>
            Terms & conditions
          </Link>
        </div>
      </div>

      <div className="mt-20 mx-10 flex flex-col-reverse justify-between pt-5 pb-10 lg:flex-row">
        <p className="text-sm font-medium text-[#2C2C2C]">© Lawyantra 2023 </p>
        <ul className="flex flex-col mb-3 space-y-2 lg:mb-0 sm:space-y-0 sm:space-x-5 sm:flex-row">
          <li>
            {/* Add social media button here */}
            <Social />
          </li>
        </ul>
      </div>
