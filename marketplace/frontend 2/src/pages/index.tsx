                  ...
                  <div className="w-11/12 sm:w-2/3 lg:flex justify-center items-center flex-col mb-5 sm:mb-10">
                    ...
                    <div className="sm:grid sm:grid-cols-2 flex flex-wrap gap-10 justify-center mt-10">
                      <div className="p-4 max-w-sm col-span-1">
                        <div className="text-center mb-10 text-2xl font-medium leading-8	">
                          <span className="text-primarycolor">Client</span>,
                          Your Right Lawyer Awaits Here.
                        </div>
                        <div className="group relative overflow-hidden border border-[#D7D7D7] bg-transparent px-6 pt-10 pb-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm rounded-3xl sm:px-10">
                          <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-primarycolor transition-all duration-300 group-hover:scale-[10]"></span>
                      ...
                      <div className="p-4 max-w-sm col-span-1">
                        <div className="text-center mb-10 text-2xl font-medium leading-8	">
                          <span className="text-primarycolor">Lawyers</span>,
                          here’s Your New Home Base.
                        </div>
                        <div className="group relative overflow-hidden border border-[#D7D7D7] bg-transparent px-6 pt-10 pb-8 transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl sm:mx-auto sm:max-w-sm rounded-3xl sm:px-10">
                          <span className="absolute top-10 z-0 h-20 w-20 rounded-full bg-primarycolor transition-all duration-300 group-hover:scale-[10]"></span>
                          <div className="relative z-10 mx-auto max-w-md">
