  ...
  return (
    <Layout>
      ...
      <section className="flex justify-center items-center">
        <div className="max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 text-center">
          {/* <div className="lg:items-center lg:content-center"> */}
          ...
          {/* <div className="lg:mt-0 lg:col-span-5 lg:flex place-content-center">
            <img src="client-home.svg" alt="mockup" />
          </div> */}
        </div>
      </section>
      {/* Our Offering */}
