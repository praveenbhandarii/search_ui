                ...
                <div class="hs-accordion-group">
                  {cases.map((singleCase) => (
                    ...
                    >
                      ...
                      >
                        <div class="pb-4 px-5">
                          <p>Filing Number: {singleCase.filing_number}</p>
                          <p>Date of Filing: {singleCase.date_of_filing}</p>
                        </div>
                        <Link
                          href="/client/dashboard/trackcase/[id]"
                          as={`/client/dashboard/trackcase/${singleCase.case_id}`}
                        >
